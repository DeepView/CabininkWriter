...
namespace Cabinink.Writer.UI
{
   ...
   public class FolderNameEditor : UITypeEditor
   {
      ...
      {
         BrowserPathDialog browser = new BrowserPathDialog();
         if (value != null)
         {
            browser.DirectoryPath = string.Format("{0}", value);
         }
         if (browser.ShowDialog(null) == DialogResult.OK) return browser.DirectoryPath;
         return value;
      }
   }
   /// <summary>
   ...
   public class BrowserPathDialog : Component
   {
      public BrowserPathDialog()
      {
      }
      /// <summary>
