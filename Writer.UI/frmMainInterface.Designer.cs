...
namespace Cabinink.Writer.UI
{
   partial class frmMainInterface
   {
      ...
      private void InitializeComponent()
      {
         ...
         // 
         this.时间同步ToolStripMenuItem.AutoSize = false;
         this.时间同步ToolStripMenuItem.ForeColor = System.Drawing.Color.White;
         this.时间同步ToolStripMenuItem.Margin = new System.Windows.Forms.Padding(0, 2, 2, 2);
         this.时间同步ToolStripMenuItem.Name = "时间同步ToolStripMenuItem";
         this.时间同步ToolStripMenuItem.Padding = new System.Windows.Forms.Padding(0, 5, 0, 5);
         this.时间同步ToolStripMenuItem.Size = new System.Drawing.Size(265, 30);
         this.时间同步ToolStripMenuItem.Text = "时间同步";
         this.时间同步ToolStripMenuItem.Click += new System.EventHandler(this.时间同步ToolStripMenuItem_Click);
         // 
         // toolStripSeparator6
         // 
