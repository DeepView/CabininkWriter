...
namespace Cabinink.Writer.UI
{
   public partial class VsSkinExceptionForm : Cabinink.Writer.UI.VsSkinFormBase
   {
      ...
      private void btnClose_Click(object sender, EventArgs e)
      {
         ...
         string asmversion = "程序集完全限定名称：" + AssemblyInformation.AssemblyFullName + "\n";
         ...
         string fcon = asmversion + happened + osname + osversion + osplatform + uiculture + cpuid + pctype + rtbStackTrackInfo.Text;
