...
{
   partial class VsSkinNotOccupationFocusForm
   {
      /// <summary>
      /// 必需的设计器变量。
      /// </summary>
      ...
      private void InitializeComponent()
      {
         ...
         // 
         // VsSkinNotOccupationFocusForm
         // 
         this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 12F);
         this.ClientSize = new System.Drawing.Size(284, 262);
         this.Name = "VsSkinNotOccupationFocusForm";
         this.Load += new System.EventHandler(this.VsSkinNotOccupationFocusForm_Load);
